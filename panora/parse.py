...
upload_path = '../upload/upload_panos/';
web_path = '/var/www/html/panora/';
...
content = []
file_path = web_path + "assets/map_temp.js"
dest_path = web_path + "script/map_util.js"
...
file_path = web_path + "assets/pano_tmp.html"
i = 0
for info in content:
    dest_path = web_path + "pano" + str(i) + ".html"
    i += 1
    # Create temp file
    fh, abs_path = mkstemp()
    with open(abs_path, 'w') as new_file:
